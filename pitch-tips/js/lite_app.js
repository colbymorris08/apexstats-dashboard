  ...
  const defaultCues = [
    {
      ...
      timestamp_window: "Set Position Pause (0:02.3 into clip / -0.35s before knee lift)",
      second_mark: "0:02.3",
      anchor_a: 2.30,
      anchor_b: 2.00,
      hedges_d: 1.04,
    ...
    },
    {
      ...
      timestamp_window: "Balance Point Apex (0:02.0 into clip / -0.28s before hand break)",
      second_mark: "0:02.0",
      anchor_a: 2.00,
      anchor_b: 1.70,
      hedges_d: 0.98,
    ...
    },
    {
      ...
      timestamp_window: "Stride Initiation (0:01.3 into clip / -0.15s before foot plant)",
      second_mark: "0:01.3",
      anchor_a: 1.30,
      anchor_b: 1.00,
      hedges_d: 0.88,
    ...
    },
    {
      ...
      timestamp_window: "Hand Break Phase (0:01.0 into clip / -0.10s before foot plant)",
      second_mark: "0:01.0",
      anchor_a: 1.00,
      anchor_b: 0.70,
      hedges_d: 0.85,
