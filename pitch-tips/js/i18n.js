...
const PREFLIGHT_TRANSLATIONS = {
  en: {
    ...
    showcase_lede: "Compare deliveries frame-by-frame with interactive sliders and examine top-5 physical discrepancy leads.",
    showcase_card_roupp_title: "Landen Roupp · SF Giants",
    showcase_card_roupp_badge: "UNLOCKED SHOWCASE",
    showcase_card_roupp_desc: "Curveball (CU) vs. Sinker/Changeup (SI/CH) delivery compare. Glove elevation offset (~0.06 torso lengths higher at leg lift peak) and stretch settle tempo.",
    showcase_card_roupp_btn: "Open Interactive Compare Slider →",
    ...
    showcase_card_erod_btn: "Open Interactive Compare Slider →",
    ...
    showcase_card_webb_btn: "Open Interactive Compare Slider →",
  ...
  ja: {
    ...
    showcase_eyebrow: "インタラクティブ動作比較",
    showcase_h2: "検証済み 投球動作差異ショーケース",
    showcase_lede: "スライダー操作で投球フォームをフレーム単位で重ね合わせ比較し、トップ5の動作差を確認できます。",
    showcase_card_roupp_title: "ランデン・ループ · SFジャイアンツ",
    showcase_card_roupp_badge: "公開ショーケース",
    showcase_card_roupp_desc: "カーブ (CU) と シンカー/チェンジアップ (SI/CH) の動作比較。足上げ頂点でのグラブ高さの差（約0.06胴体比）とセット静止テンポ。",
    showcase_card_roupp_btn: "インタラクティブ比較スライダーを開く →",
    ...
    showcase_card_erod_btn: "インタラクティブ比較スライダーを開く →",
    ...
    showcase_card_webb_btn: "インタラクティブ比較スライダーを開く →",
  ...
  ko: {
    ...
    showcase_eyebrow: "인터랙티브 폼 비교",
    showcase_h2: "검증된 투구폼 물리적 차이 쇼케이스",
    showcase_lede: "슬라이더를 조작하여 투구 폼을 프레임별로 겹쳐보고 상위 5개 동작 차이를 확인할 수 있습니다.",
    showcase_card_roupp_title: "랜든 룹 · SF 자이언츠",
    showcase_card_roupp_badge: "공개 쇼케이스",
    showcase_card_roupp_desc: "커브(CU) vs 싱커/체인지업(SI/CH) 투구폼 비교. 킥 정점에서의 글러브 높이 차이(약 0.06 몸통비율) 및 세트 정지 템포.",
    showcase_card_roupp_btn: "인터랙티브 비교 슬라이더 열기 →",
    ...
    showcase_card_erod_btn: "인터랙티브 비교 슬라이더 열기 →",
    ...
    showcase_card_webb_btn: "인터랙티브 비교 슬라이더 열기 →",
  ...
  es: {
    ...
    showcase_eyebrow: "Muestras Interactivas",
    showcase_h2: "Patrones Mecánicos Verificados",
    showcase_lede: "Compare entregas cuadro por cuadro con controles deslizantes e inspeccione los principales indicadores físicos.",
    showcase_card_roupp_title: "Landen Roupp · SF Giants",
    showcase_card_roupp_badge: "MUESTRA DESBLOQUEADA",
    showcase_card_roupp_desc: "Comparación de Curva (CU) vs Sinker/Cambio (SI/CH). Diferencia de elevación del guante (~0.06 torsos en el pico de pierna) y tempo en el set.",
    showcase_card_roupp_btn: "Abrir Comparador Interactivo →",
    ...
    showcase_card_erod_btn: "Abrir Comparador Interactivo →",
    ...
    showcase_card_webb_btn: "Abrir Comparador Interactivo →",
  ...
  "zh-TW": {
    ...
    showcase_eyebrow: "互動式動作對比",
    showcase_h2: "已驗證投球物理動作差異展示",
    showcase_lede: "使用拉桿逐影格重疊比較投球動作，檢視前五大關鍵物理差異特徵。",
    showcase_card_roupp_title: "Landen Roupp · 舊金山巨人",
    showcase_card_roupp_badge: "已解鎖展示",
    showcase_card_roupp_desc: "曲球 (CU) 與 伸卡/變速球 (SI/CH) 動作比較。抬腿最高點的手套高度差（約 0.06 軀幹長度）與準備動作靜止節奏。",
    showcase_card_roupp_btn: "開啟互動式重疊拉桿 →",
    ...
    showcase_card_erod_btn: "開啟互動式重疊拉桿 →",
    ...
    showcase_card_webb_btn: "開啟互動式重疊拉桿 →",
