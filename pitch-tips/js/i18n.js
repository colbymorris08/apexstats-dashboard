...
const PREFLIGHT_TRANSLATIONS = {
  en: {
    ...
    hero_btn_bauer: "LMB: Trevor Bauer 🇲🇽 →",
    ...
    meta_pitchers_val: "Roupp (MLB), Burns (NCAA), Sasaki (NPB), Choi (KBO), Gu Lin (CPBL), Bauer (LMB)",
  ...
  es: {
    ...
    meta_pitchers_val: "Bauer (LMB), Sasaki (NPB), Burns (NCAA), Choi (KBO), Gu Lin (CPBL), Roupp (MLB)",
  ...
  "zh-TW": {
    ...
    meta_pitchers_val: "古林睿煬 (CPBL), 佐佐木朗希 (NPB), Burns (NCAA), 崔原態 (KBO), Bauer (LMB), Roupp (MLB)",
